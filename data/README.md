...
The rime-cantonese data (release ce0be9e, with a CC BY 4.0 license) is
incorporated into rust-canto for word segmentation and
characters-to-Jyutping conversion.

Data source: https://github.com/rime/rime-cantonese/tree/ce0be9e

License: CC BY 4.0. A copy is included at `data/LICENSE.txt`.
